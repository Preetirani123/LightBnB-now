...
VALUES
(1, 'speed lamp', 'description', 'url', 'url', $930.00, 2, 3, 4, 'Canada', '8th ave', 'Vancouver', 'BC',  'R0G 0A1')
(2, 'Blank Corner', 'description', 'url', 'url', $830.00, 1, 2, 4, 'Canada', '9th ave', 'surrey', 'BC',  'R0G 0A3')
(3, 'Habit', 'description', 'url', 'url', $530.00, 2, 1, 2, 'Canada', '4th ave', 'Burnaby', 'BC',  'R0G 0A9')
